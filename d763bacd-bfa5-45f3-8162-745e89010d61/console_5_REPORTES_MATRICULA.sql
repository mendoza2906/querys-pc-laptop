...
select * from aca.estudiante_matricula where id_estudiante_matricula = 209022
...
--         distinct ea.*
--             distinct   em.*
        distinct em.id_estudiante_oferta,em.id_estudiante_matricula,pa.codigo,om.carrera,p.id,p.identificacion,p.apellidos,p.nombres,
                 eo.numero_matricula,tm.descripcion as tipoMatricula,ma.id_nivel, ma.id_malla_asignatura,ea.id_paralelo,ea.id_estudiante_asignatura,a.descripcion as asignatura,ea.codigo_estado_matricula,ea.promedio,
...
--     and cast(em.fecha_ing as date)='2024-07-29' --and cast(em.fecha_ing as time(0))='10:04:20'
       and p.identificacion in ('2450370354', '0928708122','0941221954','2400301210','0953539806')
    --and ma.id_nivel  = 5
...
--     and ma.id_malla_asignatura = 322
